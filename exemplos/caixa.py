...
vertices[0] = [-1.0, -1.0]  #caixa
vertices[1] = [+1.0, -1.0]
vertices[2] = [-1.0, +1.0]
vertices[3] = [+1.0, +1.0]

vertices[4] = [-0.9, -0.7]  #caixa contorno interno
vertices[5] = [-0.9, +0.9]
vertices[6] = [+0.9, -0.7]
vertices[7] = [+0.9, +0.9]

vertices[8] = [-0.9, +0.8]  #caixa diagonal interna
vertices[9] = [+0.8, -0.7]
vertices[10] = [-0.9, +0.9]
vertices[11] = [+0.9, -0.7]
vertices[12] = [+0.9, +0.9]

vertices[13] = [+1.0, +1.0]  #caixa sombra
vertices[14] = [+1.0, -1.0]
vertices[15] = [+1.2, +1.0]
vertices[16] = [+1.2, -1.0]

vertices[17] = [-0.9, -0.95]  #caixa detalhe
vertices[18] = [-0.9, -0.75]
vertices[19] = [+0.9, -0.95]
vertices[20] = [+0.9, -0.75]
